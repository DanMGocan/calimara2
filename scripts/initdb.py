    ...
    try:
        ...
        with engine.connect() as connection:
            ...
            try:
                ...
                print("  Email: gocandan@gmail.com")
                print("  Authentication: Google OAuth (test google_id: admin-google-id-123456789)")
                print("  Blog URL: dangocan.calimara.ro")
                print("  Admin Privileges: YES")
                print("  Moderation Privileges: YES")
                print("  Access: Full admin and moderation control panel")
